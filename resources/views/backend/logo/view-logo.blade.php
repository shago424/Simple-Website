          ...
          <section class="col-md-12">
           ...
           <div class="card">
              <div class="card-header">
                <h5>Logo List
                  @if($countlogo<1)
                  <a  href="{{route('logos.add')}}" class="btn btn-success btn-sm float-right"><i class="fa fa-plus-circle"> Add Logo</i></a>
                  @endif
                </h5>
              </div> 
            <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                    <a title="Edit" href="{{route('logos.edit',$logo->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                    <a title="Delete" id="delete" href="{{route('logos.delete',$logo->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                      </td> 
                    </tr>
                    @endforeach
                  </tbody>
